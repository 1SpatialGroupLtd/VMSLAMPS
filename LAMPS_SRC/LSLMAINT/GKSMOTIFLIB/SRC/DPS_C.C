 ...
 *
 * Timestamp of this file for the 2002 release was: 2001-12-19 20:20:20.000000000 +0000
 *
...
extern void GKS_FREE_NAME_TABLE();
		...
		char	*glyph_name)
{
   ...
   c->glyph_name = malloc(strlen(glyph_name) + 1);
   if (c->glyph_name != NULL)
      strcpy(c->glyph_name,glyph_name);
   else
      c->glyph_name = NULL;
}
...
extern float GKS_C_GET_CHAR_WIDTH(
		...
		int	*charno)
{
   /* float  ret_width = finf->charptr[*charno].width; */

   float ret_width = 0.0;

   if (finf->charptr != NULL)
      ret_width = finf->charptr[*charno].width;

   if (ret_width == 0.0)
      ret_width = finf->default_width;
   
   return ret_width; 
}

/*----------------------------------------------------------------------*/
/* EXTERN GKS_C_SET_DEFAULT_WIDTH					*/
/*......................................................................*/
/*									*/
/* Sets the default width for a character in the font (the width of a	*/
/* space)								*/
/*----------------------------------------------------------------------*/

extern void GKS_C_SET_DEFAULT_WIDTH(Finfo	*finf)
{
   finf->default_width = GKS_C_GET_CHAR_WIDTH(finf,&(' '));
}
...
/*----------------------------------------------------------------------*/
/* EXTERN GKS_C_GET_ENCODING						*/
/*......................................................................*/
/*									*/
/* Fill in the encoding vector from the font (afm) file. This is the	*/
/* glyph name of each of the first 256 characters in the font.		*/
/*									*/
/* The names in the encoding vector are read only			*/
/*----------------------------------------------------------------------*/

extern int GKS_C_GET_ENCODING(Finfo	*finf,
	                      char	*glyph_name[256])
{
   int        	i;
   Character 	*c;

   /* if there are no characters in the font, return an error	*/
...
/*----------------------------------------------------------------------*/
/* EXTERN GKS_C_FIND_VALID_FONT						*/
/*......................................................................*/
/*									*/
/* Find the first font definition that contains width information	*/
/*----------------------------------------------------------------------*/

extern Finfo *GKS_C_FIND_VALID_FONT(float	*scale,
	                            int		*kerned,
	                            long	**namtab,
	                            int		*r_to_l,
	                            int		*arabic)
...
/*----------------------------------------------------------------------*/
/* EXTERN GKS_C_FIND_DEFAULT_FONT  					*/
/*......................................................................*/
/*									*/
/* Find the first font definition that contains width information	*/
/*----------------------------------------------------------------------*/

extern int *GKS_C_FIND_DEFAULT_FONT()
{
   int 		i;
   Finfo 	*finf=fptr;
   int		ret_font = -1;
