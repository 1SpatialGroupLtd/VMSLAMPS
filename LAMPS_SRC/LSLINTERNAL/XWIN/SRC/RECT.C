 ...
 *
 * Timestamp of this file for the 2002 release was: 1989-07-18 10:59:02.000000000 +0100
 *
...
main()
{
  ...
  int rectw=100, recth=100;  /* rectangle width and height */

  int win2x=600, win2y=400;
  int win2h=400, win2w=400;
...
/*       XClearWindow(dpy,win);*/
       XClearArea( dpy, win, oldx, oldy, rectw, recth, 0);
       XSetForeground(dpy, gc, cols[i%8]);
       XSetBackground(dpy, gc, cols[(7-(i%8))]);
       XFillRectangle(dpy, win, gc, x,y, recth,rectw);
